...
\begin{refsection}
	...
	{\include{contents/kapitel_0_en}}		% 
	{\include{contents/kapitel_0}} 	        % Einleitung
	%
	\ifthenelse{\equal{\isenglish}{true}}%
	{\include{contents/kapitel_1_en}}		% Introduction
	{\include{contents/kapitel_1}} 	        %
	%
	\ifthenelse{\equal{\isenglish}{true}}%
	{\include{contents/kapitel_2_en}}		% Theory
	{\include{contents/kapitel_2}} 	        %
	%
	\ifthenelse{\equal{\isenglish}{true}}%
	{\include{contents/kapitel_3_en}}		% Implementation
	{\include{contents/kapitel_3}} 	        %
	%
	\ifthenelse{\equal{\isenglish}{true}}%
	{\include{contents/theend}}		        % Result and Discussion
	{\include{contents/schluss}} 	        % Zusammenfassung
	%
	\ifthenelse{\equal{\isenglish}{true}}%
	{\include{contents/kapitel_5_en}}{}	        % Conclusion and Outlook
	%
	\ifthenelse{\equal{\isenglish}{true}}%
	{\include{contents/kapitel_6_en}}{}	        % Future Work
